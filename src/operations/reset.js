...
const ResetTags = () => {
  return [
    ...
    { id: 3, name: "Family Time", cssClass: 'tagColor3', comment: "" },
    { id: 4, name: "Work", cssClass: 'tagColor9', comment: "Work 8-5 every week day (with one-hour lunch break)"},
    { id: 5, name: "Recreation", cssClass: 'tagColor5', comment: ""},
    { id: 6, name: "Spirituality", cssClass: 'tagColor2', comment: ""},
  ];
}
...
const DefaultPlan = () => {
  ...
  plan[0] = [1, 1, 1, 1, 1, 1, 1, 2, null, null, null, null, 2, null, null, null, null, 2, null, null, null, null, 1, 1 ];
  plan[1] = [1, 1, 1, 1, 1, 1, 1, 2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 3, 3, 5, 5, 1, 1 ];
  plan[2] = [1, 1, 1, 1, 1, 1, 1, 2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 3, 3, 5, 5, 1, 1 ];
  plan[3] = [1, 1, 1, 1, 1, 1, 1, 2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 3, 3, 5, 5, 1, 1 ];
  plan[4] = [1, 1, 1, 1, 1, 1, 1, 2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 3, 3, 5, 5, 1, 1 ];
  plan[5] = [1, 1, 1, 1, 1, 1, 1, 2, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 3, 3, 5, 5, 1, 1 ];
  plan[6] = [1, 1, 1, 1, 1, 1, 1, 2, null, null, null, null, 2, null, null, null, null, 2, null, null, null, null, 1, 1 ];
  return plan;
}
